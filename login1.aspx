            ...
            <table cellpedding="10" cellspacing="5">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rflogin" runat="server" ErrorMessage="*Username is Required" ForeColor="Red" ControlToValidate="txtusername" ValidationGroup="a"></asp:RequiredFieldValidator>
                ...
                <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfpass" runat="server" ErrorMessage="*Password is Required" ForeColor="Red" ControlToValidate="txtpwd" ValidationGroup="a"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    &nbsp;<asp:HyperLink ID="hpforget" runat="server" NavigateUrl="~/forgetpass.aspx">Forget Password ?</asp:HyperLink>
                    </td>
                </tr>
                </table>
                </center>
